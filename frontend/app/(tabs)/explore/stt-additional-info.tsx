...
export default function STTAdditionalInfoScreen() {
  ...
  const handleDonePress = () => {
    if (hasRecorded) {
      ...
      setTimeout(() => {
        ...
        // Navigate back to the additional-info screen
        ...
        <View style={styles.content}>
          <View style={styles.speechBubbleContainer}>
            ...
            <View style={styles.textWrapper}>
              <AnimatedTypingText
                text="Please share your additional thoughts."
